...
class RegisterForm(forms.ModelForm):
    user_id = forms.CharField(
        label="아이디",
        required=True,
        widget=forms.TextInput(attrs={"class": "user-id", "placeholder": "아이디"}),
    ...
    user_pw = forms.CharField(
        label="비밀번호",
        required=True,
        widget=forms.PasswordInput(attrs={"class": "user-pw", "placeholder": "비밀번호"}),
    ...
    user_pw_confirm = forms.CharField(
        ...
        widget=forms.PasswordInput(
            attrs={"class": "user-pw-confirm", "placeholder": "비밀번호 확인"}
        ),
    ...
    user_email = forms.EmailField(
        label="이메일",
        required=True,
        widget=forms.EmailInput(attrs={"class": "user-email", "placeholder": "이메일"}),
        error_messages={"required": "이메일을 입력해주세요."},
    )

    field_order = ["user_id", "user_pw", "user_pw_confirm", "user_name", "user_email"]
    ...
    def clean(self):
        ...
        if user_id == "":
            ...
            try:
                ...
                return self.add_error("user_pw", "비밀번호가 다릅니다.1")
